...
Project Manager: Will Kwan (Student ID: 27280890\)  
Team Members:
...
- Students: Primary users who will rely on the system for navigation and accessing event information.  
...
- External data providers: Any source of campus maps, room schedules, or event information.
...
- UI mockup  
- Interactive campus map with building and event  
...
- Ability for faculty and admins to create, edit, and delete events. Faculty will have restrictions, while admins will not. 
...
- A major constraint with this project is the time limit. We are limited to 8 weeks of development with around 10 hours of work per week per developer. This limits the number of features we can implement and the overall scope of the project. Moreover, there are only going to be 4 developers working on this project, which limits the features  
- Data availability for scheduling (room access and who may be using the room), building access, and events will also be limited to open data provided by UBC or third parties  
- There is a budget constraint of $0, limiting this project to using free/open source resources and limiting the deployment of this project.

**AI Disclaimer**  
Portions of this assignment were prepared with the assistance of AI tools, which were used  
to generate ideas, improve clarity, and refine wording. All content has been critically  
reviewed, verified, and finalized to ensure accuracy.

**Project Charter Acceptance**  
Will Kwan (Developer, Project Manager) \- Will Kwan   
Kelvin Chen (Developer) \- Kelvin Chen Sep 19, 2025 12:30 PM PDT  
James Birnie (Developer) \-JAMES BIRNIE  
Peter Szabo (Developer) \- ***PETER SZABO  SEP 19, 2025 12:30 PM PDT***
